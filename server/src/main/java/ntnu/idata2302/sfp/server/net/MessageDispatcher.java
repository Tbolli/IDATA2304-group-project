...
public final class MessageDispatcher {
   ...
   * @param handler the handler instance to invoke for messages of {@code type}; must not be {@code null}
   ...
   *
   * @param packet  the received {@link SmartFarmingProtocol} packet to dispatch; must not be {@code null}
   * @param client  the client {@link Socket} that sent the packet; may be {@code null}
   * @param context the {@link ServerContext} providing server state and utilities for handlers; must not be {@code null}
